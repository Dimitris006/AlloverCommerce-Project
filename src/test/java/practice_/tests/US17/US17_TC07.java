...
public class US17_TC07 {
    ...
    public void testcase07() {
        ...
        //Click on Orders
        JSUtils.clickWithTimeoutByJS(alloverCommerceMyAccountPage.ordersLink);
        WaitUtils.waitFor(2);

        //Verify the details of shopping is seen
        BrowserUtils.verifyElementDisplayed(alloverCommerceCheckoutPage.theDetailsOfShopping);
        Driver.closeDriver();
