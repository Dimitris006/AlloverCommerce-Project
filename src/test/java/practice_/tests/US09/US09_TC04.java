...
public class US09_TC04 {
    ...
    @Test
    public void verificationCodeNegativeTest() {
        // Go to home page
        ...
        Assert.assertTrue(WaitUtils.waitForVisibility(alloverCommerceVendorRegistrationPage.invalidVerificationCodeMessage, 5).isDisplayed()
        );
        WaitUtils.waitFor(2);
        Driver.closeDriver();
    }
