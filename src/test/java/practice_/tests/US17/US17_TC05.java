...
public class US17_TC05 {
    ...
    public void testcase05() {
        ...
        //Click Wire transfer/EFT radio button
        actions.scrollByAmount(1,500);
        actions.perform();
        alloverCommerceCheckoutPage.wireEFTRadioButton.click();

        //Verify Wire transfer/EFT radio button is clickable
        BrowserUtils.verifyElementClickable(alloverCommerceCheckoutPage.wireEFTRadioButton);

        //Click Pay at the door radio button
        alloverCommerceCheckoutPage.payAtTheDoorRadioButton.click();

        //Verify Pay at the door radio button is clickable
        BrowserUtils.verifyElementClickable(alloverCommerceCheckoutPage.payAtTheDoorRadioButton);
        Driver.closeDriver();
    }
}
